<?php
namespace JLTELMM\Inc\Classes\Notifications\Base;
...
trait User_Data {
	...
	public function is_local_server() {
		...
		return apply_filters( 'jltelmm_is_local', $is_local );
	}
	...
	public function get_collect_data( $user_id, $arr = [] ){
		...
		$data = array(
			...
			'is_active_product'		  => 1,
			'installed_product_slug'  => JLTELMM_SLUG,
		);

		$payload_data =  array_merge( $arr, $data );
		$endpoint_url = \JLTELMM\Libs\Helper::crm_endpoint();
