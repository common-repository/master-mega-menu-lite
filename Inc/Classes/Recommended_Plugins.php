	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'options-general.php',       // Ex. master-mega-menu-lite-settings /  edit.php?post_type=page .
				__( 'Recommended', 'master-mega-menu-lite' ),
				__( 'Recommended', 'master-mega-menu-lite' ),
				'manage_options',
				'master-mega-menu-lite-recommended-plugins',
