<?php
namespace JLTELMM\Inc\Megamenu\Controls;

use Elementor\Base_Data_Control;

if ( ! defined( 'ABSPATH' ) ) { exit; };

class JLTMA_Control_Visual_Select extends Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'master-addons-editor', JLTELMM_ASSETS . 'css/master-mega-menu-editor.css' );
		wp_enqueue_script( 'master-visual-select' , JLTELMM_ASSETS . 'js/visual-select.js', array( 'jquery' ), JLTELMM_VER, true );
		wp_enqueue_script( 'master-addons-editor', JLTELMM_ASSETS . 'js/editor.js', array( 'jquery' ), JLTELMM_VER, true );
	}
